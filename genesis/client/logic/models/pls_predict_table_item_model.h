#pragma once
#ifndef PLS_PREDICT_TABLE_ITEM_MODEL_H
#define PLS_PREDICT_TABLE_ITEM_MODEL_H
...
namespace Model
{
  ...
  class PlsPredictTableItemModel : public QAbstractTableModel
  {
    Q_OBJECT

  public:
    explicit PlsPredictTableItemModel(QObject* parent);
