...
namespace Views
{
ViewPageProjectData::ViewPageProjectData(QWidget* parent)
  : View(parent)
{
  SetupUi();
}

ViewPageProjectData::~ViewPageProjectData()
{
}

void ViewPageProjectData::SetupUi()
{
  //// Self
  ...
  //// Caption
  {
    QLabel* catpion = new QLabel(tr("Data"), this);
