#ifndef TREE_WIDGET_IMPORTED_IDENTIFICATION_TABLES_H
#define TREE_WIDGET_IMPORTED_IDENTIFICATION_TABLES_H
...
class TreeWidgetImportedIdentificationTables : public QWidget
{
  Q_OBJECT

public:
  explicit TreeWidgetImportedIdentificationTables(QWidget *parent = nullptr);
  ~TreeWidgetImportedIdentificationTables();
