#pragma once
#ifndef TREE_WIDGET_COEFFICIENT_TABLES_H
#define TREE_WIDGET_COEFFICIENT_TABLES_H
...
class TreeWidgetCoefficientTables : public QWidget
{
	Q_OBJECT

public:
	explicit TreeWidgetCoefficientTables(QWidget* parent = nullptr);
	~TreeWidgetCoefficientTables();
...
private:
	Ui::TreeWidgetCoefficientTables* ui;
